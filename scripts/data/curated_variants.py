"""
Mutation Microscope - Curated Benchmark Variants
=================================================

Declarative benchmark records for the 7 curated human genetic variants
in GRCh38 evaluated by Mutation Microscope.

Every numerical value, genomic coordinate, and sequence has been audited and classified
under the 6-class scientific provenance framework:
  1. live_api: Genuine live API responses via DeepMind gRPC
  2. atlas: DeepMind AlphaGenome Atlas predictions
  3. published_exact: Exact numerical values from Avsec et al., Nature 2026
  4. derived: Computed or transformed from published figures or datasets
  5. reconstructed: Mathematically approximated or interpolated
  6. illustrative: Hand-crafted or synthetic educational examples

Variants included:
  1. APOA1 (chr11:116837649:T>G) - Official AlphaGenome Skill Golden Example (Promoter study)
  2. COL6A2 (chr21:46029302:G>A) - Official AlphaGenome Skill & Nature 2026 Splicing Benchmark
  3. HBA2 (chr16:173545:A>G) - Official AlphaGenome Skill Golden Example (PolyA study)
  4. TERT (chr5:1295113:G>A) - Nature 2026 Regulatory Landmark (C228T promoter)
  5. SMN2 (chr5:70951946:C>T) - Nature 2026 Splicing Benchmark (c.840C>T exon 7)
  6. BCL11A (chr2:60495255:C>T) - Nature 2026 Erythroid Enhancer (+58kb GATA1 locus)
  7. CFTR (chr7:117642567:A>G) - External Biological Negative Control (c.3870A>G synonymous)
"""
